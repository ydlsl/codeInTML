...
function setOutputDir() {
  const arr = new Map([
    ...
    ['index_test1', 'Publish/PublishTest01/pc'],
    ['index_test2', 'Publish/PublishTest02/pc'],
    ['index_release', 'Publish/Release/pc'],
    ['h5_debug', 'Publish/Debug/h5'],
    ['h5_test1', 'Publish/PublishTest01/h5'],
    ['h5_test2', 'Publish/PublishTest02/h5'],
    ['h5_release', 'Publish/Release/h5'],
  ])
  ...
  var outputDir = arr.get(arg+'_'+NODE_ENV) || 'Publish/Debug';
  return outputDir;
}
